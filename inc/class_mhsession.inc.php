...
class mhSession {
  ...
  public function showEditForm() {
    ...
    for ($i = 0; $i < 20; $i++)
    {
      ...
      echo "</select>";
      echo "</td>";
      echo "<td><input type=\"text\" name=\"mhsaldo[$i]\" style=\"width:80px;\" value=\"" .  $edsaldo[$i] . "\" maxlength=\"10\"/></td>";
      echo "<td><input type=\"text\" name=\"mhhwons[$i]\" style=\"width:80px;\" value=\"" .  $edhwon[$i] . "\" maxlength=\"4\"/></td>";
      echo "<td><input type=\"text\" name=\"mhbuyin[$i]\" style=\"width:80px;\" value=\"" .  $edbuyin[$i] . "\" maxlength=\"2\"/></td>";
      echo "<td><input type=\"text\" name=\"mhgamep[$i]\" style=\"width:80px;\" value=\"" .  $edplays[$i] . "\" maxlength=\"4\"/></td>";
      echo "<td><input type=\"text\" name=\"mhpenal[$i]\" style=\"width:80px;\" value=\"" .  $edpenalty[$i] . "\" maxlength=\"10\"/></td>";
      echo "</tr>\n";
    }
    echo "</table><div><br />";   
